...
with (root/"data/measurements.csv").open("w",newline="") as f:w=csv.DictWriter(f,fieldnames=columns);w.writeheader();w.writerows(sorted(rows,key=lambda r:r["public_measurement_id"]))
